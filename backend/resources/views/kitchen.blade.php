...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .hero { background:linear-gradient(135deg, rgba(22,163,74,0.08) 0%, rgba(204,153,51,0.06) 100%); border-radius:16px; padding:14px; display:flex; align-items:center; justify-content:space-between; gap:12px; border:1px solid var(--af-line); box-shadow: var(--af-shadow); }

...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .layout { display:grid; grid-template-columns: minmax(0, 1fr) minmax(280px, 420px); gap:14px; align-items:start; }
        ...
        .order { border:1px solid var(--af-line); border-radius:16px; padding:14px; background:#fff; box-shadow:0 16px 30px rgba(0,0,0,0.05); min-height:200px; display:grid; gap:12px; position:relative; }
        ...
        .order-meta-row { display:flex; gap:8px; flex-wrap:wrap; align-items:center; font-size:12px; color:rgba(0,0,0,0.65); }
        ...
        .kitchen-actions { margin:4px 0 2px; display:flex; flex-wrap:wrap; gap:6px; }
